...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 14, 2017 at 03:10 PM
...
CREATE TABLE `bill` (
  ...
  `actual_weight` float(10,3) DEFAULT NULL,
  `charge_kg` float(10,3) DEFAULT NULL,
  `rate_kg` float(10,3) DEFAULT NULL,
  `pay_or_not_pay` varchar(10) DEFAULT NULL,
  `pay_paid_price` float(10,2) DEFAULT NULL,
  `hamali` float(10,2) DEFAULT NULL,
  `cc` float(10,2) DEFAULT NULL,
  `bc` float(10,2) DEFAULT NULL,
  `total` float(10,2) DEFAULT NULL,
  `gst_tax` float(10,2) DEFAULT NULL,
  `grand_total` float(10,2) DEFAULT NULL,
  `ramarks` text,
  `delivery_at` text,
  `price_in_word` text,
  `biil_date` date DEFAULT NULL,
...
INSERT INTO `bill` (`id`, `bill_no`, `truck_no`, `consignor`, `consignee`, `from_destination`, `to_destination`, `actual_weight`, `charge_kg`, `rate_kg`, `pay_or_not_pay`, `pay_paid_price`, `hamali`, `cc`, `bc`, `total`, `gst_tax`, `grand_total`, `ramarks`, `delivery_at`, `price_in_word`, `biil_date`, `company_id`, `add_date`, `add_uid`, `del_uid`, `del_date`, `status`) VALUES
(1, 1, NULL, 1, 2, 'Rajkot', 'Ahemdbad', NULL, 10.000, NULL, '', 10.00, 10.00, 10.00, 10.00, 60.00, 3.00, 63.00, '20', '30', 'SIXTY-THREE', '0000-00-00', 1, '2017-10-14 14:15:00', 1, NULL, NULL, 1);
...
INSERT INTO `bill_product` (`id`, `bill_id`, `product_name`, `product_weight`, `company_id`, `add_date`) VALUES
(1, 1, '123', 40.000, 1, NULL),
(2, 1, '20', 30.000, 1, NULL);
...
CREATE TABLE `company_master` (
  ...
  `mobile_no1` varchar(30) DEFAULT NULL,
  `mobile_no2` varchar(30) DEFAULT NULL,
  `address` text,
  ...
  `del_date` datetime DEFAULT NULL,
  `del_uid` int(11) DEFAULT NULL,
  `status` tinyint(4) DEFAULT '1' COMMENT '1 for active ,0 For deactive'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `company_master` (`id`, `user_name`, `password`, `company_logo`, `email`, `gst_no`, `cst_no`, `pan_no`, `mobile_no1`, `mobile_no2`, `address`, `comapny_name`, `user_agent`, `platform`, `last_login`, `add_date`, `add_uid`, `del_date`, `del_uid`, `status`) VALUES
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', NULL, 'admin@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1);
...
INSERT INTO `party` (`id`, `party_name`, `party_code`, `mobile_no`, `phone_no`, `address`, `country_id`, `state_id`, `city_id`, `zip_code`, `company_id`, `add_date`, `add_uid`, `del_date`, `del_uid`, `status`) VALUES
(1, 'Dharmesh', '123', '8758004155', '265326', 'Gondal Road', 101, 12, 1011, '36002', 1, '2017-10-14 07:43:29', 1, NULL, NULL, 1),
(2, 'Dhaval Patel', 'Dha123', '8758004155', '123456', 'Gimmy Tower, Gondal Road', 101, 12, 1011, '360002', 1, '2017-10-14 07:48:11', 1, NULL, NULL, 1);
...
INSERT INTO `truck_master` (`id`, `truck_no`, `company_id`) VALUES
(1, 'GJ-3HD-7525', 1),
(2, 'GJ-3HD-6824', 1);
